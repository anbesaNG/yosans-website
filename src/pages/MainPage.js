...
function MainPage() {
    ...
    return (
        <div className='page'>
            ...
            <p>For individuals living abroad: Financial burden is one of the main reasons students are not able to continue their studies past high school education. Choosing to sponsor one student would greatly help in tackling this issue. Go to “Support Fere Project” for more information. If there are other scholarships or opportunities we have not posted, please send us an email to inform us. </p>
            <p>This is a small-scale project working on a community level. We hope this instills hope and offers stability in the Eritrean community in Sudan.</p>
        </div>
    );
}
